...
/// <summary>
/// AVX-512 kernel executor implementation providing high-performance vectorized operations
/// using 512-bit vector registers with advanced optimization techniques.
/// </summary>
internal sealed class Avx512KernelExecutor(KernelDefinition definition, KernelExecutionPlan executionPlan) : SimdKernelExecutor(definition, executionPlan)
{
    ...
    /// </summary>
    /// <param name="input1">First input buffer (a).</param>
    /// <param name="input2">Second input buffer (b).</param>
    /// <param name="input3">Third input buffer (c).</param>
    /// <param name="output">Output buffer for result.</param>
    ...
    /// <summary>
    /// Optimized float32 execution with advanced loop unrolling and pipelining.
    /// </summary>
        ...
        KernelOperation operation)
    {
        ...
        var vectorOp = Avx512OperationHelpers.GetVectorOperationFloat32(operation);
    ...
    /// <summary>
    /// Optimized double precision execution using AVX-512.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        ...
        KernelOperation operation)
    {
        ...
        // Get function pointer for the specific operation
        var vectorOp = Avx512OperationHelpers.GetVectorOperationFloat64(operation);
    ...
    /// <summary>
    /// Executes 3-operand FMA operation: result = a * b + c using AVX-512 FMA instructions for double precision.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
