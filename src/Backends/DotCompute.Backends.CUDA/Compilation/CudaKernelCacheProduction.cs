...
/// </summary>
public sealed class CudaKernelCacheProduction : IDisposable
{
    private readonly ILogger<CudaKernelCacheProduction> _logger;
    ...
    public CudaKernelCacheProduction(
        ILogger<CudaKernelCacheProduction> logger,
