...
namespace DotCompute.Backends.CUDA.BLAS
{
...
public sealed class CuBLASWrapper : IDisposable
{
    ...
    private static extern CublasStatus cublasCreate_v2(ref IntPtr handle);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDestroy_v2(IntPtr handle);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSetStream_v2(IntPtr handle, IntPtr streamId);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSetMathMode(IntPtr handle, CublasMath mode);

    // BLAS Level 1 Operations
    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSaxpy_v2(IntPtr handle, int n, ref float alpha, IntPtr x, int incx, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDaxpy_v2(IntPtr handle, int n, ref double alpha, IntPtr x, int incx, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSdot_v2(IntPtr handle, int n, IntPtr x, int incx, IntPtr y, int incy, ref float result);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDdot_v2(IntPtr handle, int n, IntPtr x, int incx, IntPtr y, int incy, ref double result);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSnrm2_v2(IntPtr handle, int n, IntPtr x, int incx, ref float result);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDnrm2_v2(IntPtr handle, int n, IntPtr x, int incx, ref double result);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSscal_v2(IntPtr handle, int n, ref float alpha, IntPtr x, int incx);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDscal_v2(IntPtr handle, int n, ref double alpha, IntPtr x, int incx);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasScopy_v2(IntPtr handle, int n, IntPtr x, int incx, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDcopy_v2(IntPtr handle, int n, IntPtr x, int incx, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasIsamax_v2(IntPtr handle, int n, IntPtr x, int incx, ref int result);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasIdamax_v2(IntPtr handle, int n, IntPtr x, int incx, ref int result);

    // BLAS Level 2 Operations
    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSgemv_v2(IntPtr handle, CublasOperation trans, int m, int n, 
        ref float alpha, IntPtr A, int lda, IntPtr x, int incx, ref float beta, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDgemv_v2(IntPtr handle, CublasOperation trans, int m, int n,
        ref double alpha, IntPtr A, int lda, IntPtr x, int incx, ref double beta, IntPtr y, int incy);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasStrsv_v2(IntPtr handle, CublasFillMode uplo, CublasOperation trans,
        CublasDiagType diag, int n, IntPtr A, int lda, IntPtr x, int incx);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDtrsv_v2(IntPtr handle, CublasFillMode uplo, CublasOperation trans,
        CublasDiagType diag, int n, IntPtr A, int lda, IntPtr x, int incx);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSger_v2(IntPtr handle, int m, int n, ref float alpha,
        IntPtr x, int incx, IntPtr y, int incy, IntPtr A, int lda);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDger_v2(IntPtr handle, int m, int n, ref double alpha,
        IntPtr x, int incx, IntPtr y, int incy, IntPtr A, int lda);

    // BLAS Level 3 Operations
    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSgemm_v2(IntPtr handle, CublasOperation transa, CublasOperation transb,
        int m, int n, int k, ref float alpha, IntPtr A, int lda, IntPtr B, int ldb, ref float beta, IntPtr C, int ldc);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDgemm_v2(IntPtr handle, CublasOperation transa, CublasOperation transb,
        int m, int n, int k, ref double alpha, IntPtr A, int lda, IntPtr B, int ldb, ref double beta, IntPtr C, int ldc);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasStrsm_v2(IntPtr handle, CublasSideMode side, CublasFillMode uplo,
        CublasOperation trans, CublasDiagType diag, int m, int n, ref float alpha, IntPtr A, int lda, IntPtr B, int ldb);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDtrsm_v2(IntPtr handle, CublasSideMode side, CublasFillMode uplo,
        CublasOperation trans, CublasDiagType diag, int m, int n, ref double alpha, IntPtr A, int lda, IntPtr B, int ldb);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasSsyrk_v2(IntPtr handle, CublasFillMode uplo, CublasOperation trans,
        int n, int k, ref float alpha, IntPtr A, int lda, ref float beta, IntPtr C, int ldc);

    [DllImport("cublas64_12", CallingConvention = CallingConvention.Cdecl)]
    private static extern CublasStatus cublasDsyrk_v2(IntPtr handle, CublasFillMode uplo, CublasOperation trans,
        int n, int k, ref double alpha, IntPtr A, int lda, ref double beta, IntPtr C, int ldc);
    ...
    private void Initialize()
    {
        ...
        {
            cublasSetMathMode(_cublasHandle, CublasMath.TensorOpMath);
    ...
    public async Task<CudaMemoryBuffer> AxpyAsync(float alpha, CudaMemoryBuffer x, CudaMemoryBuffer y, CancellationToken cancellationToken = default)
    {
        ...
        await _device.SynchronizeAsync(cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var aPointers = new IntPtr[batchCount];
        var bPointers = new IntPtr[batchCount];
        var cPointers = new IntPtr[batchCount];
        ...
        try
        {
            ...
            await _device.CopyToDeviceAsync(aHandle.AddrOfPinnedObject(), devA, (ulong)(batchCount * IntPtr.Size)).ConfigureAwait(false);
            await _device.CopyToDeviceAsync(bHandle.AddrOfPinnedObject(), devB, (ulong)(batchCount * IntPtr.Size)).ConfigureAwait(false);
            await _device.CopyToDeviceAsync(cHandle.AddrOfPinnedObject(), devC, (ulong)(batchCount * IntPtr.Size)).ConfigureAwait(false);
        ...
        CudaMemoryBuffer A, int n, CancellationToken cancellationToken = default)
    {
        ...
        await PerformLUDecompositionKernel(work, L, U, pivot, n, cancellationToken).ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await PerformCholeskyDecompositionKernel(L, n, upper, cancellationToken).ConfigureAwait(false);
        ...
        CudaMemoryBuffer A, int m, int n, CancellationToken cancellationToken = default)
    {
        ...
        await PerformQRDecompositionKernel(A, Q, R, m, n, cancellationToken).ConfigureAwait(false);
    ...
    private void ValidateVectorDimensions(CudaMemoryBuffer x, CudaMemoryBuffer y)
    {
    ...
    private async Task PerformLUDecompositionKernel(CudaMemoryBuffer work, CudaMemoryBuffer L, CudaMemoryBuffer U, 
    ...
    private async Task PerformCholeskyDecompositionKernel(CudaMemoryBuffer L, int n, bool upper, 
    ...
    private async Task PerformQRDecompositionKernel(CudaMemoryBuffer A, CudaMemoryBuffer Q, CudaMemoryBuffer R, 
    ...
    public void Dispose()
    {
        if (!_disposed)
        {
            ...
            {
                cublasDestroy_v2(_cublasHandle);
