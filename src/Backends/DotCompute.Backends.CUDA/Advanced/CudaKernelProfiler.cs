...
public sealed class CudaKernelProfiler : IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                await ExecuteKernelOnceAsync(functionHandle, arguments, launchConfig, startEvent, endEvent, cancellationToken);
            }
            ...
            _profileData.AddOrUpdate(kernelName, profileData, (k, v) => profileData);
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Wait for completion
        await Task.Run(() => CudaRuntime.cudaEventSynchronize(endEvent), cancellationToken);
    ...
    /// </summary>
    private ThroughputMetrics CalculateThroughput(double avgTimeMs, Abstractions.KernelArguments arguments)
    {
    ...
    /// </summary>
    private static long EstimateMemoryFootprint(Abstractions.KernelArguments arguments)
    {
        long totalSize = 0;
