...
public sealed class CudaCooperativeGroupsManager : IDisposable
{
    ...
    private CudaCooperativeGroupsMetrics _metrics;
    ...
    public void PerformMaintenance()
    {
            ...
            try
        {
            ...
            {
                _cooperativeKernels.TryRemove(kernel.Id, out _);
            }
    ...
    private IntPtr PrepareLaunchParameters(KernelArguments arguments, CudaCooperativeLaunchConfig config)
    {
...
public sealed class CudaCooperativeLaunchConfig
{
    ...
    public uint SharedMemBytes { get; set; } = 0;
