...
namespace DotCompute.Backends.CUDA.Advanced
{
    ...
    public sealed class CudaUnifiedMemoryAdvanced : IDisposable
    {
        ...
        private readonly CudaUnifiedMemoryMetrics _metrics;
            ...
            CancellationToken cancellationToken)
        {
            ...
            _ = await SetOptimalAdviceAsync(buffer, CudaMemoryUsageHint.ReadMostly, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        private static CudaMemoryAdvise ConvertToAdvice(CudaMemoryUsageHint hint)
        {
            return hint switch
            {
