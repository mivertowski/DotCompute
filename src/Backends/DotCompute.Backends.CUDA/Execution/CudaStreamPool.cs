...
internal sealed class CudaStreamPool : IDisposable
{
    ...
    private void Initialize()
    {
        ...
        for (int i = 0; i < INITIAL_HIGH_PRIORITY_COUNT; i++)
        {
        ...
        for (int i = 0; i < INITIAL_NORMAL_PRIORITY_COUNT; i++)
        {
        ...
        for (int i = 0; i < INITIAL_LOW_PRIORITY_COUNT; i++)
        {
...
internal sealed class PooledCudaStreamHandle : CudaStreamHandle
{
    ...
    private volatile bool _poolDisposed;
