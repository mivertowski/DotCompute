...
namespace DotCompute.Backends.CUDA.Types.Native.Structs
{
    ...
    public struct CudaBatchMemOpNodeParams : IEquatable<CudaBatchMemOpNodeParams>
    {
        ...
        public override readonly bool Equals(object? obj) => obj is CudaBatchMemOpNodeParams other && Equals(other);

        /// <summary>
        /// Returns the hash code for this instance.
        /// </summary>
        /// <returns>A 32-bit signed integer hash code.</returns>
        public override readonly int GetHashCode() => HashCode.Combine(ctx, count, paramArray, flags);
        ...
        public static bool operator ==(CudaBatchMemOpNodeParams left, CudaBatchMemOpNodeParams right) => left.Equals(right);
