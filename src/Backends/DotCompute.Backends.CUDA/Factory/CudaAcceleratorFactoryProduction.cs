...
namespace DotCompute.Backends.CUDA.Factory
{
    ...
    /// </summary>
    public sealed class CudaAcceleratorFactoryProduction : IBackendFactory, IDisposable
    {
        private readonly ILogger<CudaAcceleratorFactoryProduction> _logger;
        ...
        public CudaAcceleratorFactoryProduction(
            ILogger<CudaAcceleratorFactoryProduction>? logger = null,
            IServiceProvider? serviceProvider = null)
        {
            _logger = logger ?? new NullLogger<CudaAcceleratorFactoryProduction>();
            ...
            ProductionConfiguration config)
        {
            ...
            var kernelCacheLogger = new NullLogger<CudaKernelCacheProduction>();
            ...
            var kernelCache = new CudaKernelCacheProduction(kernelCacheLogger);
        ...
        public class ProductionCudaAccelerator : CudaAccelerator
        {
            ...
            public CudaKernelCacheProduction KernelCache { get; }
            ...
            public ProductionCudaAccelerator(
                ...
                CudaKernelCacheProduction kernelCache,
