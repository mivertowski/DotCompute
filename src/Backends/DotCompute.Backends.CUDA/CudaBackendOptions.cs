...
public sealed class CudaBackendOptions
{
    ...
    /// </summary>
    public bool EnableMultiDevice { get; set; } = false;
    ...
    /// </summary>
    public int DefaultStreamPriority { get; set; } = 0;
    ...
    /// </summary>
    public bool EnableSynchronousExecution { get; set; } = false;
    ...
    /// </summary>
    public bool LogKernelLaunches { get; set; } = false;
}
