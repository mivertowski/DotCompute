...
public class HardwareAbstractionLayer
{
    ...
    private HashSet<string> GetCpuFeatures()
    {
        ...
        if (hardware.SupportsSsse3) features.Add("SSSE3");
        if (hardware.SupportsSse41) features.Add("SSE4.1");
        if (hardware.SupportsSse42) features.Add("SSE4.2");
        if (hardware.SupportsAvx) features.Add("AVX");
        if (hardware.SupportsAvx2) features.Add("AVX2");
        if (hardware.SupportsAvx512F) features.Add("AVX-512");
