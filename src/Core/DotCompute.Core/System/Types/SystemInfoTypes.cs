...
/// </para>
/// <para>
/// Generated by <see cref="SystemInfoManager.GetSystemInfo"/> with platform-specific
/// data collection for Windows (WMI), Linux (/proc), macOS (sysctl/vm_stat), and FreeBSD.
/// </para>
...
public sealed class SystemInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// CPU architecture from <see cref="RuntimeInformation.OSArchitecture"/>.
    ...
    /// "Ubuntu 22.04", "macOS 14 Sonoma"). From <see cref="RuntimeInformation.OSDescription"/>.
    /// </remarks>
    ...
    /// <see cref="Process.WorkingSet64"/>. Includes both managed and native memory.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Total virtual address space reserved by process. From <see cref="Process.VirtualMemorySize64"/>.
    ...
    /// </summary>
    /// <remarks>
    /// Number of threads in current process. From <see cref="Process.Threads"/>. Includes
    ...
    /// <see cref="Process.HandleCount"/>. Windows-specific metric.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Duration since process started. Calculated from <see cref="Process.StartTime"/>.
    /// </remarks>
...
/// </para>
/// <para>
/// Retrieved by <see cref="SystemInfoManager.GetDetailedMemoryInfo"/>.
/// </para>
/// <para><b>Thread Safety</b>: Immutable snapshot, safe for concurrent access.</para>
/// </remarks>
