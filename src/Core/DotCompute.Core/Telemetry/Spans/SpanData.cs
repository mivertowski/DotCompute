...
/// <summary>
/// Represents immutable span data captured during trace execution.
/// Contains all the essential information about a completed span.
/// </summary>
public sealed class SpanData
{
    ...
    /// Provides a human-readable description of what this span tracked.
    /// </summary>
    ...
    /// Represents the completion time of the tracked operation.
    /// </summary>
