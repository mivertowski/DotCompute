...
/// <summary>
/// Contains comprehensive performance data for a single memory operation.
/// Captures detailed metrics about memory transfer efficiency and access patterns.
/// </summary>
public sealed class MemoryOperationProfile
{
    /// <summary>
    /// Gets or sets the type of memory operation performed.
    /// Identifies the specific kind of memory operation being profiled.
    /// </summary>
    /// <value>The operation type as a string (e.g., "Copy", "Allocate", "Free").</value>
    public string OperationType { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the identifier of the device where the memory operation occurred.
    /// Links the memory operation to a specific compute device.
    /// </summary>
