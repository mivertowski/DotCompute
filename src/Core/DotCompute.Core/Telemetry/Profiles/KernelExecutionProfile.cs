...
/// <summary>
/// Contains comprehensive performance data for a single kernel execution.
/// Captures detailed metrics about compute efficiency, memory usage, and resource utilization.
/// </summary>
public sealed class KernelExecutionProfile
{
    /// <summary>
    /// Gets or sets the name of the kernel that was executed.
    /// Identifies the specific compute operation being profiled.
    /// </summary>
    /// <value>The kernel name as a string.</value>
    public string KernelName { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the identifier of the device where the kernel executed.
    /// Links the performance data to a specific compute device.
    /// </summary>
