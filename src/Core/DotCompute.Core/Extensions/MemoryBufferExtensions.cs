...
public static class MemoryBufferExtensions
{
    ...
    {
        return buffer.CopyFromHostAsync<T>(data.AsMemory(), offset, cancellationToken);
    }
    ...
    public static ValueTask WriteAsync<T>(
        ...
        CancellationToken cancellationToken = default) where T : unmanaged
    {
        return buffer.CopyFromHostAsync<T>(data, offset, cancellationToken);
    }
    ...
    public static ValueTask ReadAsync<T>(
        ...
        CancellationToken cancellationToken = default) where T : unmanaged
    {
        return buffer.CopyToHostAsync<T>(data.AsMemory(), offset, cancellationToken);
    }
