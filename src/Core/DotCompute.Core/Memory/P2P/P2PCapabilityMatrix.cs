...
namespace DotCompute.Core.Memory.P2P
{
    ...
    internal sealed class DeviceTopologyInfo
    {
        ...
        public required AcceleratorType DeviceType { get; init; }
        /// <summary>
        /// Gets or sets the supports p2 p.
        /// </summary>
        /// <value>The supports p2 p.</value>
        public required bool SupportsP2P { get; init; }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the max p2 p bandwidth g bps.
        /// </summary>
        /// <value>The max p2 p bandwidth g bps.</value>
        public required double MaxP2PBandwidthGBps { get; init; }
        /// <summary>
    ...
    /// <summary>
    /// P2P path candidate for pathfinding algorithms.
    /// </summary>
    internal sealed class P2PPathCandidate
    {
        ...
        public required IAccelerator CurrentDevice { get; init; }
        /// <summary>
        /// Gets or sets the path.
        /// </summary>
        /// <value>The path.</value>
        public required List<IAccelerator> Path { get; init; }
        /// <summary>
        /// Gets or sets the total bandwidth.
        /// </summary>
        /// <value>The total bandwidth.</value>
        public required double TotalBandwidth { get; init; }
        /// <summary>
        /// Gets or sets the total latency.
        /// </summary>
        /// <value>The total latency.</value>
        public required double TotalLatency { get; init; }
    }

    /// <summary>
    /// P2P path information including multi-hop paths.
    /// </summary>
    public sealed class P2PPath
    {
        ...
        /// </summary>
        /// <value>The total bandwidth g bps.</value>
        public required double TotalBandwidthGBps { get; init; }
        /// <summary>
        /// Gets or sets the estimated latency ms.
        /// </summary>
        /// <value>The estimated latency ms.</value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether direct p2 p.
        /// </summary>
        /// <value>The is direct p2 p.</value>
        public required bool IsDirectP2P { get; init; }
    }
    ...
    public sealed class P2PConnection
    {
        ...
        /// <summary>
        /// Gets or sets the last validated.
        /// </summary>
        /// <value>The last validated.</value>
        public required DateTimeOffset LastValidated { get; init; }
    }

    /// <summary>
    /// P2P topology analysis results.
    /// </summary>
    public sealed class P2PTopologyAnalysis
    {
        ...
        /// <summary>
        /// Gets or sets the total possible connections.
        /// </summary>
        /// <value>The total possible connections.</value>
        public int TotalPossibleConnections { get; set; }
        /// <summary>
        /// Gets or sets the p2 p enabled connections.
        /// </summary>
        /// <value>The p2 p enabled connections.</value>
        public int P2PEnabledConnections { get; set; }
        /// <summary>
        /// Gets or sets the p2 p connectivity ratio.
        /// </summary>
        /// <value>The p2 p connectivity ratio.</value>
        public double P2PConnectivityRatio { get; set; }
        /// <summary>
        /// Gets or sets the average n v link bandwidth.
        /// </summary>
        /// <value>The average n v link bandwidth.</value>
        public double AverageNVLinkBandwidth { get; set; }
        /// <summary>
        /// Gets or sets the average p c ie bandwidth.
        /// </summary>
        /// <value>The average p c ie bandwidth.</value>
        public double AveragePCIeBandwidth { get; set; }
        /// <summary>
        /// Gets or sets the average infini band bandwidth.
        /// </summary>
        /// <value>The average infini band bandwidth.</value>
    ...
    /// <summary>
    /// P2P topology cluster information.
    /// </summary>
    public sealed class P2PTopologyCluster
    {
        ...
        public required double AverageBandwidth { get; init; }
        /// <summary>
        /// Gets or sets the interconnect density.
        /// </summary>
        /// <value>The interconnect density.</value>
        public required double InterconnectDensity { get; init; }
    }

    /// <summary>
    /// P2P bandwidth bottleneck identification.
    /// </summary>
    public sealed class P2PBandwidthBottleneck
    {
        ...
        public required double BandwidthGBps { get; init; }
        /// <summary>
        /// Gets or sets the expected bandwidth g bps.
        /// </summary>
        /// <value>The expected bandwidth g bps.</value>
        public required double ExpectedBandwidthGBps { get; init; }
        /// <summary>
        /// Gets or sets the connection type.
        /// </summary>
        /// <value>The connection type.</value>
        public required P2PConnectionType ConnectionType { get; init; }
    }

    /// <summary>
    /// High-performance P2P path identification.
    /// </summary>
    public sealed class P2PHighPerformancePath
    {
        ...
        public required P2PConnectionType ConnectionType { get; init; }
        /// <summary>
        /// Gets or sets the performance ratio.
        /// </summary>
        /// <value>The performance ratio.</value>
        public required double PerformanceRatio { get; init; }
    }
    ...
    /// <summary>
    /// Comprehensive matrix statistics.
    /// </summary>
    public sealed class P2PMatrixStatistics
    {
        ...
        public int P2PEnabledConnections { get; set; }
        /// <summary>
        /// Gets or sets the n v link connections.
        /// </summary>
        /// <value>The n v link connections.</value>
        public int NVLinkConnections { get; set; }
        /// <summary>
        /// Gets or sets the p c ie connections.
        /// </summary>
        /// <value>The p c ie connections.</value>
        public int PCIeConnections { get; set; }
        /// <summary>
        /// Gets or sets the infini band connections.
        /// </summary>
        /// <value>The infini band connections.</value>
        ...
        /// <summary>
        /// Gets or sets the peak bandwidth g bps.
        /// </summary>
        /// <value>The peak bandwidth g bps.</value>
        ...
        /// <summary>
        /// Gets or sets the matrix build time.
        /// </summary>
        /// <value>The matrix build time.</value>
        public DateTimeOffset MatrixBuildTime { get; set; }
        /// <summary>
