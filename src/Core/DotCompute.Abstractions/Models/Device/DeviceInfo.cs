...
/// </summary>
/// <remarks>
/// This type is returned by <see cref="Interfaces.IComputeOrchestrator.GetDeviceInfo"/>
/// to help consumers understand what compute capabilities are available.
/// </remarks>
public sealed class DeviceInfo
{
    ...
    /// </summary>
    public static DeviceInfo CpuOnly => new()
    {
        HasGpu = false,
        PreferredBackend = ComputeBackendType.CPU,
        DeviceName = Environment.GetEnvironmentVariable("PROCESSOR_IDENTIFIER") ?? "CPU",
