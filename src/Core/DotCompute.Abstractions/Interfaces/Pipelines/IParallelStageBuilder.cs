...
public interface IParallelStageBuilder
{
    ...
    IParallelStageBuilder AddKernel(string kernelName, Action<IKernelStageBuilder>? stageBuilder = null);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithMaxDegreeOfParallelism(int maxDegreeOfParallelism);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithResultAggregation(Func<IEnumerable<object>, object> aggregator);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithErrorHandling(ParallelErrorStrategy strategy, bool continueOnError = false);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithTimeout(TimeSpan timeout);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithMemorySharing(MemorySharingMode sharingMode);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithWorkPartitioning(Func<object, IEnumerable<object>> partitioner);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithPriority(DotCompute.Abstractions.Pipelines.Enums.ExecutionPriority priority);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithBarriers(params string[] barrierPoints);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithResourceAllocation(ResourceAllocationStrategy strategy);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithMonitoring(bool enableDetailedMetrics = true);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithAffinity(IEnumerable<AffinityRule> affinityRules);
    ...
    /// <returns>The parallel stage builder for fluent configuration</returns>
    IParallelStageBuilder WithAdaptiveExecution(AdaptationPolicy adaptationPolicy);
}