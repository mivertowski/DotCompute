...
public sealed class KernelRegistrationEmitter
{
    ...
    /// </remarks>
    public static string GenerateKernelRegistry(IReadOnlyList<KernelMethodInfo> kernelMethods, IReadOnlyList<KernelClassInfo> kernelClasses, Compilation? compilation = null)
    {
        ...
        foreach (var method in kernelMethods)
        {
            ...
            var (cudaSource, cudaEntryPoint, cudaNeedsLength) = KernelExecutionMetadataEmitter.GenerateCuda(method, compilation);
