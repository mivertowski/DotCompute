...
using CorePipelineExecutionMetrics = DotCompute.Abstractions.Pipelines.Models.PipelineExecutionMetrics;
using CoreMemoryUsageStats = DotCompute.Core.Pipelines.Statistics.MemoryUsageStats;
using CoreTimeSeriesMetric = DotCompute.Core.Pipelines.Metrics.TimeSeriesMetric;
using CoreIStageMetrics = DotCompute.Abstractions.Interfaces.Pipelines.IStageMetrics;
