...
namespace DotCompute.Linq.Compilation.Analysis
{
    ...
    {
        /// <summary>Gets or sets whether the expression is parallelizable.</summary>
        public bool IsParallelizable { get; set; }

        /// <summary>Gets or sets whether vectorization is suitable.</summary>
        public bool VectorizationSuitable { get; set; }

        /// <summary>Gets or sets the type of parallelization.</summary>
        public ParallelizationType ParallelizationType { get; set; }

        /// <summary>Gets or sets the recommended degree of parallelism.</summary>
        public int RecommendedParallelism { get; set; } = 1;

        /// <summary>Gets or sets the optimal parallelization strategy.</summary>
        public ParallelizationStrategy Strategy { get; set; }

        /// <summary>Gets or sets the estimated speedup from parallelization.</summary>
        public double EstimatedSpeedup { get; set; } = 1.0;

        /// <summary>Gets or sets thread safety characteristics.</summary>
        public ThreadSafetyLevel ThreadSafety { get; set; }

        /// <summary>Gets or sets data dependencies that affect parallelization.</summary>
        public List<string> DataDependencies { get; set; } = new();

        /// <summary>Gets or sets constraints that limit parallelization.</summary>
    ...
    public enum ParallelizationType
    {
        ...
        None,
        /// <summary>Element-wise parallel operations.</summary>
        ElementWise,
        /// <summary>Reduction operations (sum, count, etc.).</summary>
        Reduction,
        /// <summary>Parallel sorting algorithms.</summary>
        Sort,
        /// <summary>Conditional parallel execution.</summary>
        Conditional,
        /// <summary>Pipeline parallelization.</summary>
        Pipeline
    }
    ...
    {
        /// <summary>Sequential execution (no parallelization).</summary>
        Sequential,
        /// <summary>Data parallel execution.</summary>
        DataParallel,
        /// <summary>Vectorized parallel execution with SIMD.</summary>
        VectorizedParallel,
        /// <summary>Map-reduce pattern.</summary>
        MapReduce,
        /// <summary>Parallel sorting.</summary>
        ParallelSort,
        /// <summary>Conditional parallel execution.</summary>
        ConditionalParallel,
        /// <summary>Task-based parallelization.</summary>
        TaskParallel
    }
    ...
    {
        /// <summary>Thread-safe, no synchronization needed.</summary>
        ThreadSafe,
        /// <summary>Requires synchronization for thread safety.</summary>
        RequiresSynchronization,
        /// <summary>Not thread-safe, sequential execution required.</summary>
        Unsafe
    }
}