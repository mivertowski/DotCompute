...
public sealed class CudaKernelTemplate : IKernelTemplate
{
    ...
    public DotCompute.Abstractions.Kernels.Types.KernelLanguage Language => DotCompute.Abstractions.Kernels.Types.KernelLanguage.CUDA;
    ...
    public KernelTemplateValidationResult Validate(KernelMetadata metadata, KernelEntryPoint entryPoint)
    {
        ...
        if (metadata.Language != DotCompute.Abstractions.Kernels.Types.KernelLanguage.CUDA && metadata.Language != DotCompute.Abstractions.Kernels.Types.KernelLanguage.Auto)
        {
    ...
    private static int GetTypeSize(Type type)
    {
        return type switch
        {
            ...
            var t when t == typeof(byte) || t == typeof(sbyte) || t == typeof(bool) => 1,
            _ => 4 // Default size
        };
    }
