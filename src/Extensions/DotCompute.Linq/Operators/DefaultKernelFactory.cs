...
public class DefaultKernelFactory : IKernelFactory
{
    ...
    public IReadOnlyList<DotCompute.Abstractions.Kernels.Types.KernelLanguage> GetSupportedLanguages(IAccelerator accelerator)
        ...
        return new[] { DotCompute.Abstractions.Kernels.Types.KernelLanguage.CSharp };
    ...
    private static bool IsOperationSupported(IKernelGenerator generator, string operationType)
        // Try to generate a test kernel to check support
            ...
            return false;
    private static DotCompute.Abstractions.Kernels.Types.KernelLanguage GetKernelLanguageForAccelerator(AcceleratorType acceleratorType)
        return acceleratorType switch
            AcceleratorType.CUDA => DotCompute.Abstractions.Kernels.Types.KernelLanguage.CUDA,
            ...
            AcceleratorType.CPU => DotCompute.Abstractions.Kernels.Types.KernelLanguage.OpenCL,
            AcceleratorType.GPU => DotCompute.Abstractions.Kernels.Types.KernelLanguage.OpenCL,
            _ => DotCompute.Abstractions.Kernels.Types.KernelLanguage.OpenCL
}
