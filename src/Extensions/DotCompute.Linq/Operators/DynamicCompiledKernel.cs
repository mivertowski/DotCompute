...
internal class CpuFallbackCompiledKernel : DotCompute.Abstractions.ICompiledKernel
{
    ...
    public CpuFallbackCompiledKernel(DotCompute.Abstractions.Kernels.KernelDefinition definition, ILogger logger)
    {
...
internal class MockKernelSource : IKernelSource
{
    ...
    public DotCompute.Abstractions.Enums.KernelLanguage Language { get; set; } = DotCompute.Abstractions.Enums.KernelLanguage.CSharpIL;
