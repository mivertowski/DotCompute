...
public class KernelSourceGenerator
{
    ...
    private void GenerateExpressionCode(StringBuilder sourceBuilder, Expression expression, KernelGenerationContext context)
    {
    ...
    private void GenerateMethodCallCode(StringBuilder sourceBuilder, MethodCallExpression methodCall, KernelGenerationContext context)
    {
    ...
    private void GenerateBinaryOperationCode(StringBuilder sourceBuilder, BinaryExpression binaryExpr, KernelGenerationContext context)
    {
    ...
    private void GenerateVulkanKernel(StringBuilder sourceBuilder, KernelDefinition definition)
    {
    ...
    private void GenerateParameters(StringBuilder sourceBuilder, KernelDefinition definition, string qualifier)
    {
