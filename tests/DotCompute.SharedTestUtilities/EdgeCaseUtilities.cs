...
public static class EdgeCaseUtilities
{
    ...
    /// <summary>
    /// Generates problematic string values for testing.
    /// </summary>
    public static IEnumerable<string> GetProblematicStrings()
    {
        yield return "";
        yield return " ";
        yield return "\t";
    ...
    private static long GetAvailableMemory()
    {
        try
        {
            ...
            else if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
            {
                ...
                var memTotal = lines.FirstOrDefault(l => l.StartsWith("MemAvailable:"));
                if (memTotal != null)
                {
