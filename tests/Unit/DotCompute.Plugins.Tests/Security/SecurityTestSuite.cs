...
/// </summary>
public sealed class SecurityTestSuite(ITestOutputHelper output)
{
    private static readonly string[] SuspiciousFileNames = { "hack", "crack", "keygen" };
    private readonly ITestOutputHelper _output = output;
    private readonly Mock<ILogger<PluginSandbox>> _mockLogger = new();
    ...
    public void SafeMemoryAllocation_IndexAccess_EnforcesBoundsChecking()
    {
        ...
        _ = Assert.Throws<IndexOutOfRangeException>(() => allocation[5] = 1);
        _ = Assert.Throws<IndexOutOfRangeException>(() => allocation[-1] = 1);
    }
    ...
    public void SafeMemoryAllocation_Slice_EnforcesBoundsChecking()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => allocation.Slice(-1, 5));
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => allocation.Slice(5, 10)); // Extends beyond bounds
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => allocation.Slice(15, 1)); // Start beyond bounds
    }
    ...
    public void PluginSecurityContext_RecordViolation_TracksCriticalViolations()
    {
        ...
        _ = Assert.Single(context.Violations);
    ...
    public void PluginSecurityContext_GetViolationsBySeverity_FiltersCorrectly()
    {
        ...
        // Assert
        _ = Assert.Single(highViolations);
        _ = Assert.Single(criticalViolations);
    ...
    public void SandboxPermissions_CreateRestrictive_HasMinimalPermissions()
    {
        ...
        // Assert
        _ = Assert.Single(permissions.AllowedPermissions);
    ...
    public void ResourceLimits_DefaultValues_AreReasonable()
    {
        ...
        Assert.True(limits.MaxCpuUsagePercent is > 0 and <= 100);
    ...
    public void SafeMemoryAllocation_DisposalClearsContents()
    {
        ...
        _ = Assert.Throws<ObjectDisposedException>(() => _ = allocation.Span);
    }
