// TODO: Fix Complex type issues and missing FFT methods
//
...
// 
//         // Assert
//         data[0].Real.Should().BeApproximately(5, 0.0001);
//         data[0].Imaginary.Should().BeApproximately(3, 0.0001);
//     }
// 
//     [Fact]
...
//             var k = i;
//             var nMinusK = 8 - i;
//             data[k].Real.Should().BeApproximately(data[nMinusK].Real, 0.01);
//             data[k].Imaginary.Should().BeApproximately(-data[nMinusK].Imaginary, 0.01);
//         }
//     }
// 
//     [Fact]
...
// 
//         // Assert
//         data[0].Real.Should().BeApproximately(8, 0.001); // DC component
//         for (int i = 1; i < 8; i++)
//         {
//             data[i].Magnitude.Should().BeLessThan(0.001); // AC components near zero
//         }
//     }
// 
//     #endregion
...
//         for (int i = 0; i < 8; i++)
//         {
//             data[i].Real.Should().BeApproximately(original[i].Real, 0.01);
//             data[i].Imaginary.Should().BeApproximately(original[i].Imaginary, 0.01);
//         }
//     }
// 
//     [Fact]
...
//         data[0].Real.Should().BeApproximately(1, 0.0001);
//     }
// 
//     #endregion
// 
...
// 
//         // Assert
//         result[0].Real.Should().BeApproximately(40, 0.1); // 8 * 5
//         for (int i = 1; i < result.Length; i++)
//         {
//             result[i].Magnitude.Should().BeLessThan(0.01);
//         }
//     }
// 
//     [Fact]
...
//         result[frequency].Magnitude.Should().BeGreaterThan(maxMagnitude * 0.9);
//     }
// 
//     #endregion
// 
...
//         {
//             reconstructed[i].Should().BeApproximately(original[i], 0.1);
//         }
//     }
// 
//     [Fact]
...
// 
//         // Assert
//         data[0].Real.Should().BeApproximately(4, 0.0001);
//         data[4].Real.Should().BeApproximately(0, 0.0001);
//     }
// 
//     [Fact]
...
//         data[0].Should().Be(0);
//         data[15].Should().BeApproximately(0, 0.0001f);
//     }
// 
//     [Fact]
...
//         for (int i = 0; i < 16; i++)
//         {
//             data1[i].Real.Should().BeApproximately(data2[i].Real, 0.0001);
//             data1[i].Imaginary.Should().BeApproximately(data2[i].Imaginary, 0.0001);
//         }
//     }
// 
//     #endregion
