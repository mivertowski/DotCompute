...
public sealed class SimpleEnumTests
{
    ...
    {
        // Act & Assert
        _ = OptimizationLevel.None.Should().NotBe(OptimizationLevel.O1);
        _ = OptimizationLevel.O1.Should().NotBe(OptimizationLevel.O2);
        _ = OptimizationLevel.O2.Should().NotBe(OptimizationLevel.O3);
    }
    ...
    {
        // Act & Assert
        _ = PrecisionMode.Single.Should().NotBe(PrecisionMode.Double);
        _ = PrecisionMode.Double.Should().NotBe(PrecisionMode.Half);
        _ = PrecisionMode.Half.Should().NotBe(PrecisionMode.Single);
    }
