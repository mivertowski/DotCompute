...
public sealed class SensorReadingTests
{
    ...
    [InlineData(SensorType.ComputeUtilization, "%")]
    [InlineData(SensorType.MemoryUtilization, "%")]
    [InlineData(SensorType.FanSpeed, "%")]
    ...
    [InlineData(SensorType.PcieLinkGeneration, "")]
    ...
    [InlineData(SensorType.ThrottlingStatus, "")]
    [InlineData(SensorType.PowerThrottlingStatus, "")]
    [InlineData(SensorType.ErrorCount, "Count")]
    [InlineData(SensorType.Custom, "")]
