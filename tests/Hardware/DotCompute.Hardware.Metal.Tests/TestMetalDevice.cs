    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < deviceCount; i++)
            {
                ...
                // Note: Some properties not yet implemented in MetalDeviceInfo
        ...
        try
        {
            ...
            if (accelerator != null)
            {
                ...
                // Note: AvailableMemory property not yet implemented in MetalAccelerator
        ...
        try
        {
            ...
            if (accelerator != null)
            {
                ...
                await using var buffer = await memoryManager.AllocateAsync<float>(size / sizeof(float));
