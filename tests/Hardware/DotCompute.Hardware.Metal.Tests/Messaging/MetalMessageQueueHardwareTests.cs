...
/// <summary>
/// Hardware tests for Metal message queue implementation.
/// Validates lock-free atomic operations on real Metal devices (Apple Silicon/AMD GPUs).
/// </summary>
[Trait("Category", "Hardware")]
[Trait("Category", "Metal")]
[Trait("Category", "MessageQueue")]
public sealed class MetalMessageQueueHardwareTests : IAsyncLifetime
{
    private MetalMessageQueue<TestMessage>? _queue;
    private bool _disposed;

    public async Task InitializeAsync()
    {
        Skip.IfNot(HardwareDetection.IsMetalAvailable(), "Metal device not available");
        ...
        _queue = new MetalMessageQueue<TestMessage>(options, logger);
    ...
    public void Enqueue_Should_Write_To_GPU_Memory()
    {
        ...
        var message = new TestMessage
        {
            ...
            Payload = "Test payload for Metal GPU memory"
        };
