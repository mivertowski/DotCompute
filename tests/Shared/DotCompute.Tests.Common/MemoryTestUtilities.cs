...
public sealed class MemoryPerformanceBenchmark
{
    ...
    public async Task<BenchmarkResult> BenchmarkAllocation(AbstractionsMemory.IMemoryManager memoryManager, long bufferSize, int iterations)
    {
    ...
    public async Task<BenchmarkResult> BenchmarkCopyToHost(AbstractionsMemory.IMemoryManager memoryManager, long bufferSize, int iterations)
    {
        var buffer = await memoryManager.AllocateAsync(bufferSize);
    ...
    public async Task<BenchmarkResult> BenchmarkCopyFromHost(AbstractionsMemory.IMemoryManager memoryManager, long bufferSize, int iterations)
    {
        var buffer = await memoryManager.AllocateAsync(bufferSize);
        var hostData = new byte[bufferSize];
