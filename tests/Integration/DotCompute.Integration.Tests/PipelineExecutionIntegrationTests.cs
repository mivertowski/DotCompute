...
public class PipelineExecutionIntegrationTests : ComputeWorkflowTestBase
{
    ...
    private ComputeWorkflowDefinition CreateLinearImageProcessingPipeline()
    {
        ...
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "raw_image", "loaded_image" }
                },
                new WorkflowExecutionStage
                {
                    Name = "stage_2_blur",
                    ...
                    ArgumentNames = new[] { "loaded_image", "blurred_image" },
                ...
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "blurred_image", "edge_image" },
                    Parameters = new Dictionary<string, object> { ["width"] = imageSize, ["height"] = imageSize }
                },
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "edge_image", "processed_image" }
                }
            }
        };
    }

    private ComputeWorkflowDefinition CreateParallelProcessingPipeline()
    {
        ...
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "input_data", "channel_0", "channel_1", "channel_2" },
                ...
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "channel_0", "processed_0" },
                ...
                new WorkflowExecutionStage
                {
                    ...
                    KernelName = "process_channel",
                    ArgumentNames = new[] { "channel_1", "processed_1" },
                ...
                new WorkflowExecutionStage
                {
                    ...
                    Order = 2, // Same order = parallel execution
                    KernelName = "process_channel",
                    ArgumentNames = new[] { "channel_2", "processed_2" },
                ...
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "processed_0", "processed_1", "processed_2", "merged_result" },
                    Parameters = new Dictionary<string, object> { ["channel_size"] = dataSize }
                }
            }
        };
    ...
    private ComputeWorkflowDefinition CreateComplexDAGPipeline()
    {
        ...
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage { Name = "stage_preprocess", Order = 1, KernelName = "preprocess", ArgumentNames = new[] { "raw_data", "preprocessed" } },
                new WorkflowExecutionStage { Name = "stage_extract_a", Order = 2, KernelName = "feature_extract", ArgumentNames = new[] { "preprocessed", "features_a" }, Parameters = new Dictionary<string, object> { ["mode"] = "A" } },
                new WorkflowExecutionStage { Name = "stage_extract_b", Order = 2, KernelName = "feature_extract", ArgumentNames = new[] { "preprocessed", "features_b" }, Parameters = new Dictionary<string, object> { ["mode"] = "B" } },
                new WorkflowExecutionStage { Name = "stage_normalize_a", Order = 3, KernelName = "normalize", ArgumentNames = new[] { "features_a", "normalized_a" } },
                new WorkflowExecutionStage { Name = "stage_normalize_b", Order = 3, KernelName = "normalize", ArgumentNames = new[] { "features_b", "normalized_b" } },
                new WorkflowExecutionStage { Name = "stage_classify", Order = 4, KernelName = "classify", ArgumentNames = new[] { "normalized_a", "normalized_b", "classified" } },
                new WorkflowExecutionStage { Name = "stage_postprocess", Order = 5, KernelName = "postprocess", ArgumentNames = new[] { "classified", "final_output" } }
            }
        };
    }

    private ComputeWorkflowDefinition CreateStreamingChunkPipeline(float[] chunkData, int chunkOffset)
    {
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "chunk_data", "processed_chunk" },
    ...
    private ComputeWorkflowDefinition CreateAdaptiveLoadBalancingPipeline()
    {
        const int dataSize = 1024;
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage
                {
                    ...
                    ExecutionOptions = new ExecutionOptions
                    {
                        ...
                        LocalWorkSize = new[] { 64 } // Conservative for memory pressure
                    }
                }
            }
        };
    ...
    private ComputeWorkflowDefinition CreateIterativeFeedbackPipeline(float[] initialData, int maxIterations, float threshold)
    {
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage
                {
                    ...
                    ArgumentNames = new[] { "initial_data", "final_result", "iterations_count", "convergence_achieved" },
    ...
    private ComputeWorkflowDefinition CreateErrorPronePipeline()
    {
        const int dataSize = 512;
        var data = TestDataGenerators.GenerateFloatArray(dataSize);
        ...
        return new ComputeWorkflowDefinition
        {
            ...
            ExecutionStages = new()
            {
                new WorkflowExecutionStage { Name = "stage_1", Order = 1, KernelName = "reliable_stage", ArgumentNames = new[] { "input", "intermediate", "backup" } },
                new WorkflowExecutionStage { Name = "stage_2", Order = 2, KernelName = "error_prone_stage", ArgumentNames = new[] { "intermediate", "intermediate" } },
                new WorkflowExecutionStage { Name = "stage_3", Order = 3, KernelName = "recovery_stage", ArgumentNames = new[] { "intermediate", "backup", "final_output" } }
            },
            ContinueOnError = true // Allow pipeline to continue even if some stages fail
        };
    }

    private ComputeWorkflowDefinition CreateScalablePipeline(int numStages, int dataSize)
    {
        var data = TestDataGenerators.GenerateFloatArray(dataSize);
