...
namespace DotCompute.Abstractions.Compute.Options
{
    ...
    {
        /// <summary>
        /// Low priority execution - may be deferred when system is under load.
        /// </summary>
        Low,

        /// <summary>
        /// Normal priority execution - default priority level.
        /// </summary>
        Normal,

        /// <summary>
        /// High priority execution - preferred scheduling when possible.
        /// </summary>
        High,

        /// <summary>
        /// Critical priority execution - highest scheduling priority.
        /// </summary>
        Critical
    }
}
